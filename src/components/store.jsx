...
function store() {
  return (
	<div className='flex flex-row w-full justify-between items-center gap-10 bg-slate-50'>
		<div className='w-1/2'>
		...
		<div className='flex flex-col justify-center items-center w-1/2'>
			...
			<h2 className='font-bold text-sm mt-4'>Peterburi tee 50d/1, 11415 Tallinn, Estonia</h2>
	</div>
	</div>
  )
}
